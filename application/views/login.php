            ...
            <form action="<?=base_url()?>user_cidadao/cadastrar" class="p-5 bg-white">
              ...
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="usuario" id="usuario" value="usuario" checked>
                  <label class="form-check-label" for="usuario">
                    Cidadão
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="cooperativa" id="cooperativa" value="cooperativa">
