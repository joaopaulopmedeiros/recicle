      ...
      <div class="row align-items-center no-gutters align-items-stretch overlap-section">
        <div class="col-md-4">
          <div class="feature-1 pricing h-100 text-center">
            ...
            <a href="<?php echo base_url();?>user_criadordesafio/adicionardesafio" class="btn px-3 py-1 mt-auto">Cadastrar</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-3 pricing h-100 text-center">
            ...
            <a href="<?php echo base_url();?>user_criadordesafio/minhaconta" class="btn px-3 py-1 mt-auto">Acessar</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-1 pricing h-100 text-center">
            ...
            <a href="<?php echo base_url();?>user_criadordesafio/ecopontos" class="btn px-3 py-1 mt-auto">Abrir mapa</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container py-5">
      <div class="row justify-content-center mb-5">
        <div class="col-10 col-md-8 text-center text-uppercase">
          <h2 class="title-section">Já pensou em fazer um desafio?</h2>
        </div>
      </div>

      <div class="row justify-content-center mb-4">
        <div class="col-10 col-lg-8">
          <p class="text-section text-center">É bem fácil! Clique <a href="<?php echo base_url();?>user_criadordesafio/adicionardesafio">aqui</a> para ir para a página de criar seu próprio desafio.</p>
        </div>
      </div>

      <div class="row justify-content-center">
        <a href="<?php echo base_url();?>user_criadordesafio/desafios" class="btn btn-green mx-2 px-4 py-2 align-self-center">Ver meus desafios</a>
      </div>
    </div>
