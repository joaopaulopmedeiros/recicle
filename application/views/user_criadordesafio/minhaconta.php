        ...
        <form id="editar_conta">
          ...
          <div class="row form-group">
            <div class="col-md-6 mb-3">
              <label class="text_label" for="nome">Nome</label>
          ...
          <div class="row form-group">
            <div class="col-md-4 mb-3">
              <label class="text_label" for="doc" id="lblDoc">Documento de identificação</label>
              <input type="text" id="doc" name="doc" class="form-control" readonly>
            </div>

            <div class="col-md-4 mb-3">
              <label class="text_label" for="cep">CEP</label>
              <input type="text" id="cep" name="cep" class="form-control" readonly>
            </div>

            <div class="col-md-4 mb-3">
              <label class="text_label" for="senha">Senha</label> 
          ...
          <div class="row form-group">
            <div class="col-md-12">
              <input type="button" id="editar" onclick="editarForm()" value="Editar informações" class="btn btn-green py-2 px-4 text-white">
              <input type="submit" id="salvar" value="Salvar alterações" class="btn btn-green py-2 px-4 text-white" hidden>
