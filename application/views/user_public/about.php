      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="../images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mb-5">
              <h3>Débora Samara</h3>
           ...
           <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="../images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mb-5">
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person">
              <img src="../images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mb-5">
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person">
              <img src="../images/person_4.jpg" alt="Image" class="img-fluid rounded-circle mb-5">
              <h3>João Paulo</h3>
