      ...
      <div class="row align-items-center no-gutters align-items-stretch overlap-section">
        <div class="col-md-4">
          <div class="feature-1 h-100 text-center d-flex flex-column align-items-center">
            ...
            <a href="<?php echo base_url();?>user_cidadao/desafios" class="btn px-3 py-1 mt-auto">Participar</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-3 h-100 text-center d-flex flex-column align-items-center">
            ...
            <a href="<?php echo base_url();?>user_cidadao/minhaConta" class="btn px-3 py-1 mt-auto">Acessar</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-1 h-100 text-center d-flex flex-column align-items-center">
            ...
            <a href="<?php echo base_url();?>user_cidadao/ecopontos" class="btn px-3 py-1 mt-auto">Abrir mapa</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container py-5">
      ...
      <div class="row justify-content-center">
        <a href="<?php echo base_url();?>user_cidadao/desafios" class="btn btn-green mx-2 px-4 py-2 align-self-center">Ver todos os desafios</a>
      </div>
    </div>
